...
import "./App.css"
import { numbers, upperCaseLetters, lowerCaseLetters, specialCharacters } from './PassGen/Characters'
import { toast, ToastContainer } from 'react-toastify'
import 'react-toastify/dist/ReactToastify.css';
import { COPY_Fail, COPY_SUCCESS } from './PassGen/Message';
...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <a className='source-code' href='https://github.com/dylananderton/Password-Generator' target='_blank'><p className='source-code-text'>See the source code</p></a>
    </div>
  )
}
